...
def main():
    ...
    for i in range(1, 25): #Support
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * support["hp"])
            attack_choice_max = float(1.5 * support["attack"])
            repair_choice_max = float(1.5 * support["repair"])
            ...
            hp_choice_min = 2 * support["hp"]
            attack_choice_min = 2 * support["attack"]
            repair_choice_min = 2 * support["repair"]
            ...
            hp_choice_min = 3 * support["hp"]
            attack_choice_min = 3 * support["attack"]
            repair_choice_min = 3 * support["repair"]
            ...
            hp_choice_min = 5 * support["hp"]
            attack_choice_min = 5 * support["attack"]
            repair_choice_min = 5 * support["repair"]
            hp_choice_max = float(7.5 * support["hp"])
            attack_choice_max = float(7.5 * support["attack"])
            repair_choice_max = float(7.5 * support["repair"])
            ...
            hp_choice_min = float(7.5 * support["hp"])
            attack_choice_min = float(7.5 * support["attack"])
            repair_choice_min = float(7.5 * support["repair"])
            hp_choice_max = 10 * support["hp"]
            attack_choice_max = 10 * support["attack"]
            repair_choice_max = 10 * support["repair"]
    ...
    for i in range(26, 51): #Defense Platforms
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * defense["hp"])
            attack_choice_max = float(1.5 * defense["attack"])
            repair_choice_max = float(1.5 * defense["repair"])
            ...
            hp_choice_min = 2 * defense["hp"]
            attack_choice_min = 2 * defense["attack"]
            repair_choice_min = 2 * defense["repair"]
            ...
            hp_choice_min = 3 * defense["hp"]
            attack_choice_min = 3 * defense["attack"]
            repair_choice_min = 3 * defense["repair"]
            ...
            hp_choice_min = 5 * defense["hp"]
            attack_choice_min = 5 * defense["attack"]
            repair_choice_min = 5 * defense["repair"]
            hp_choice_max = float(7.5 * defense["hp"])
            attack_choice_max = float(7.5 * defense["attack"])
            repair_choice_max = float(7.5 * defense["repair"])
            ...
            hp_choice_min = float(7.5 * defense["hp"])
            attack_choice_min = float(7.5 * defense["attack"])
            repair_choice_min = float(7.5 * defense["repair"])
            hp_choice_max = 10 * defense["hp"]
            attack_choice_max = 10 * defense["attack"]
            repair_choice_max = 10 * defense["repair"]
    ...
    for i in range(51, 76): #Cruiser
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * cruiser["hp"])
            attack_choice_max = float(1.5 * cruiser["attack"])
            repair_choice_max = float(1.5 * cruiser["repair"])
            ...
            hp_choice_min = 2 * cruiser["hp"]
            attack_choice_min = 2 * cruiser["attack"]
            repair_choice_min = 2 * cruiser["repair"]
            ...
            hp_choice_min = 3 * cruiser["hp"]
            attack_choice_min = 3 * cruiser["attack"]
            repair_choice_min = 3 * cruiser["repair"]
            ...
            hp_choice_min = 5 * cruiser["hp"]
            attack_choice_min = 5 * cruiser["attack"]
            repair_choice_min = 5 * cruiser["repair"]
            hp_choice_max = float(7.5 * cruiser["hp"])
            attack_choice_max = float(7.5 * cruiser["attack"])
            repair_choice_max = float(7.5 * cruiser["repair"])
            ...
            hp_choice_min = float(7.5 * cruiser["hp"])
            attack_choice_min = float(7.5 * cruiser["attack"])
            repair_choice_min = float(7.5 * cruiser["repair"])
            hp_choice_max = 10 * cruiser["hp"]
            attack_choice_max = 10 * cruiser["attack"]
            repair_choice_max = 10 * cruiser["repair"]
    ...
    for i in range(76, 101): #Interdictors
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * interdictor["hp"])
            attack_choice_max = float(1.5 * interdictor["attack"])
            repair_choice_max = float(1.5 * interdictor["repair"])
            ...
            hp_choice_min = 2 * interdictor["hp"]
            attack_choice_min = 2 * interdictor["attack"]
            repair_choice_min = 2 * interdictor["repair"]
            ...
            hp_choice_min = 3 * interdictor["hp"]
            attack_choice_min = 3 * interdictor["attack"]
            repair_choice_min = 3 * interdictor["repair"]
            ...
            hp_choice_min = 5 * interdictor["hp"]
            attack_choice_min = 5 * interdictor["attack"]
            repair_choice_min = 5 * interdictor["repair"]
            hp_choice_max = float(7.5 * interdictor["hp"])
            attack_choice_max = float(7.5 * interdictor["attack"])
            repair_choice_max = float(7.5 * interdictor["repair"])
            ...
            hp_choice_min = float(7.5 * interdictor["hp"])
            attack_choice_min = float(7.5 * interdictor["attack"])
            repair_choice_min = float(7.5 * interdictor["repair"])
            hp_choice_max = 10 * interdictor["hp"]
            attack_choice_max = 10 * interdictor["attack"]
            repair_choice_max = 10 * interdictor["repair"]
    ...
    for i in range(101, 121): #Carrier
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * carrier["hp"])
            attack_choice_max = float(1.5 * carrier["attack"])
            repair_choice_max = float(1.5 * carrier["repair"])
            ...
            hp_choice_min = 2 * carrier["hp"]
            attack_choice_min = 2 * carrier["attack"]
            repair_choice_min = 2 * carrier["repair"]
            ...
            hp_choice_min = 3 * carrier["hp"]
            attack_choice_min = 3 * carrier["attack"]
            repair_choice_min = 3 * carrier["repair"]
            ...
            hp_choice_min = 5 * carrier["hp"]
            attack_choice_min = 5 * carrier["attack"]
            repair_choice_min = 5 * carrier["repair"]
            hp_choice_max = float(7.5 * carrier["hp"])
            attack_choice_max = float(7.5 * carrier["attack"])
            repair_choice_max = float(7.5 * carrier["repair"])
            ...
            hp_choice_min = float(7.5 * carrier["hp"])
            attack_choice_min = float(7.5 * carrier["attack"])
            repair_choice_min = float(7.5 * carrier["repair"])
            hp_choice_max = 10 * carrier["hp"]
            attack_choice_max = 10 * carrier["attack"]
            repair_choice_max = 10 * carrier["repair"]
    ...
    for i in range(121, 146): #Corvette
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * corvette["hp"])
            attack_choice_max = float(1.5 * corvette["attack"])
            repair_choice_max = float(1.5 * corvette["repair"])
            ...
            hp_choice_min = 2 * corvette["hp"]
            attack_choice_min = 2 * corvette["attack"]
            repair_choice_min = 2 * corvette["repair"]
            ...
            hp_choice_min = 3 * corvette["hp"]
            attack_choice_min = 3 * corvette["attack"]
            repair_choice_min = 3 * corvette["repair"]
            ...
            hp_choice_min = 5 * corvette["hp"]
            attack_choice_min = 5 * corvette["attack"]
            repair_choice_min = 5 * corvette["repair"]
            hp_choice_max = float(7.5 * corvette["hp"])
            attack_choice_max = float(7.5 * corvette["attack"])
            repair_choice_max = float(7.5 * corvette["repair"])
            ...
            hp_choice_min = float(7.5 * corvette["hp"])
            attack_choice_min = float(7.5 * corvette["attack"])
            repair_choice_min = float(7.5 * corvette["repair"])
            hp_choice_max = 10 * corvette["hp"]
            attack_choice_max = 10 * corvette["attack"]
            repair_choice_max = 10 * corvette["repair"]
    ...
    for i in range(146, 171): #Bomber
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * bomber["hp"])
            attack_choice_max = float(1.5 * bomber["attack"])
            repair_choice_max = float(1.5 * bomber["repair"])
            ...
            hp_choice_min = 2 * bomber["hp"]
            attack_choice_min = 2 * bomber["attack"]
            repair_choice_min = 2 * bomber["repair"]
            ...
            hp_choice_min = 3 * bomber["hp"]
            attack_choice_min = 3 * bomber["attack"]
            repair_choice_min = 3 * bomber["repair"]
            ...
            hp_choice_min = 5 * bomber["hp"]
            attack_choice_min = 5 * bomber["attack"]
            repair_choice_min = 5 * bomber["repair"]
            hp_choice_max = float(7.5 * bomber["hp"])
            attack_choice_max = float(7.5 * bomber["attack"])
            repair_choice_max = float(7.5 * bomber["repair"])
            ...
            hp_choice_min = float(7.5 * bomber["hp"])
            attack_choice_min = float(7.5 * bomber["attack"])
            repair_choice_min = float(7.5 * bomber["repair"])
            hp_choice_max = 10 * bomber["hp"]
            attack_choice_max = 10 * bomber["attack"]
            repair_choice_max = 10 * bomber["repair"]
    ...
    for i in range(171, 196): #Fighter
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * fighter["hp"])
            attack_choice_max = float(1.5 * fighter["attack"])
            repair_choice_max = float(1.5 * fighter["repair"])
            ...
            hp_choice_min = 2 * fighter["hp"]
            attack_choice_min = 2 * fighter["attack"]
            repair_choice_min = 2 * fighter["repair"]
            ...
            hp_choice_min = 3 * fighter["hp"]
            attack_choice_min = 3 * fighter["attack"]
            repair_choice_min = 3 * fighter["repair"]
            ...
            hp_choice_min = 5 * fighter["hp"]
            attack_choice_min = 5 * fighter["attack"]
            repair_choice_min = 5 * fighter["repair"]
            hp_choice_max = float(7.5 * fighter["hp"])
            attack_choice_max = float(7.5 * fighter["attack"])
            repair_choice_max = float(7.5 * fighter["repair"])
            ...
            hp_choice_min = float(7.5 * fighter["hp"])
            attack_choice_min = float(7.5 * fighter["attack"])
            repair_choice_min = float(7.5 * fighter["repair"])
            hp_choice_max = 10 * fighter["hp"]
            attack_choice_max = 10 * fighter["attack"]
            repair_choice_max = 10 * fighter["repair"]
    ...
    for i in range(196, 211): #Dreadnaught
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * dreadnaught["hp"])
            attack_choice_max = float(1.5 * dreadnaught["attack"])
            repair_choice_max = float(1.5 * dreadnaught["repair"])
            ...
            hp_choice_min = 2 * dreadnaught["hp"]
            attack_choice_min = 2 * dreadnaught["attack"]
            repair_choice_min = 2 * dreadnaught["repair"]
            ...
            hp_choice_min = 3 * dreadnaught["hp"]
            attack_choice_min = 3 * dreadnaught["attack"]
            repair_choice_min = 3 * dreadnaught["repair"]
            ...
            hp_choice_min = 5 * dreadnaught["hp"]
            attack_choice_min = 5 * dreadnaught["attack"]
            repair_choice_min = 5 * dreadnaught["repair"]
            hp_choice_max = float(7.5 * dreadnaught["hp"])
            attack_choice_max = float(7.5 * dreadnaught["attack"])
            repair_choice_max = float(7.5 * dreadnaught["repair"])
            ...
            hp_choice_min = float(7.5 * dreadnaught["hp"])
            attack_choice_min = float(7.5 * dreadnaught["attack"])
            repair_choice_min = float(7.5 * dreadnaught["repair"])
            hp_choice_max = 10 * dreadnaught["hp"]
            attack_choice_max = 10 * dreadnaught["attack"]
            repair_choice_max = 10 * dreadnaught["repair"]
    ...
    for i in range(211, 221): #Leviathan
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * leviathan["hp"])
            attack_choice_max = float(1.5 * leviathan["attack"])
            repair_choice_max = float(1.5 * leviathan["repair"])
            ...
            hp_choice_min = 2 * leviathan["hp"]
            attack_choice_min = 2 * leviathan["attack"]
            repair_choice_min = 2 * leviathan["repair"]
            ...
            hp_choice_min = 3 * leviathan["hp"]
            attack_choice_min = 3 * leviathan["attack"]
            repair_choice_min = 3 * leviathan["repair"]
            ...
            hp_choice_min = 5 * leviathan["hp"]
            attack_choice_min = 5 * leviathan["attack"]
            repair_choice_min = 5 * leviathan["repair"]
            hp_choice_max = float(7.5 * leviathan["hp"])
            attack_choice_max = float(7.5 * leviathan["attack"])
            repair_choice_max = float(7.5 * leviathan["repair"])
            ...
            hp_choice_min = float(7.5 * leviathan["hp"])
            attack_choice_min = float(7.5 * leviathan["attack"])
            repair_choice_min = float(7.5 * leviathan["repair"])
            hp_choice_max = 10 * leviathan["hp"]
            attack_choice_max = 10 * leviathan["attack"]
            repair_choice_max = 10 * leviathan["repair"]
    ...
    for i in range(221, 231): #Super Destroyer
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * super_destroyer["hp"])
            attack_choice_max = float(1.5 * super_destroyer["attack"])
            repair_choice_max = float(1.5 * super_destroyer["repair"])
            ...
            hp_choice_min = 2 * super_destroyer["hp"]
            attack_choice_min = 2 * super_destroyer["attack"]
            repair_choice_min = 2 * super_destroyer["repair"]
            ...
            hp_choice_min = 3 * super_destroyer["hp"]
            attack_choice_min = 3 * super_destroyer["attack"]
            repair_choice_min = 3 * super_destroyer["repair"]
            ...
            hp_choice_min = 5 * super_destroyer["hp"]
            attack_choice_min = 5 * super_destroyer["attack"]
            repair_choice_min = 5 * super_destroyer["repair"]
            hp_choice_max = float(7.5 * super_destroyer["hp"])
            attack_choice_max = float(7.5 * super_destroyer["attack"])
            repair_choice_max = float(7.5 * super_destroyer["repair"])
            ...
            hp_choice_min = float(7.5 * super_destroyer["hp"])
            attack_choice_min = float(7.5 * super_destroyer["attack"])
            repair_choice_min = float(7.5 * super_destroyer["repair"])
            hp_choice_max = 10 * super_destroyer["hp"]
            attack_choice_max = 10 * super_destroyer["attack"]
            repair_choice_max = 10 * super_destroyer["repair"]
    ...
    for i in range(231, 236): #Star Station
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * star_station["hp"])
            attack_choice_max = float(1.5 * star_station["attack"])
            repair_choice_max = float(1.5 * star_station["repair"])
            ...
            hp_choice_min = 2 * star_station["hp"]
            attack_choice_min = 2 * star_station["attack"]
            repair_choice_min = 2 * star_station["repair"]
            ...
            hp_choice_min = 3 * star_station["hp"]
            attack_choice_min = 3 * star_station["attack"]
            repair_choice_min = 3 * star_station["repair"]
            ...
            hp_choice_min = 5 * star_station["hp"]
            attack_choice_min = 5 * star_station["attack"]
            repair_choice_min = 5 * star_station["repair"]
            hp_choice_max = float(7.5 * star_station["hp"])
            attack_choice_max = float(7.5 * star_station["attack"])
            repair_choice_max = float(7.5 * star_station["repair"])
            ...
            hp_choice_min = float(7.5 * star_station["hp"])
            attack_choice_min = float(7.5 * star_station["attack"])
            repair_choice_min = float(7.5 * star_station["repair"])
            hp_choice_max = 10 * star_station["hp"]
            attack_choice_max = 10 * star_station["attack"]
            repair_choice_max = 10 * star_station["repair"]
    ...
    for i in range(236, 261): #Harvesters
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * harvester["hp"])
            attack_choice_max = float(1.5 * harvester["attack"])
            repair_choice_max = float(1.5 * harvester["repair"])
            ...
            hp_choice_min = 2 * harvester["hp"]
            attack_choice_min = 2 * harvester["attack"]
            repair_choice_min = 2 * harvester["repair"]
            ...
            hp_choice_min = 3 * harvester["hp"]
            attack_choice_min = 3 * harvester["attack"]
            repair_choice_min = 3 * harvester["repair"]
            ...
            hp_choice_min = 5 * harvester["hp"]
            attack_choice_min = 5 * harvester["attack"]
            repair_choice_min = 5 * harvester["repair"]
            hp_choice_max = float(7.5 * harvester["hp"])
            attack_choice_max = float(7.5 * harvester["attack"])
            repair_choice_max = float(7.5 * harvester["repair"])
            ...
            hp_choice_min = float(7.5 * harvester["hp"])
            attack_choice_min = float(7.5 * harvester["attack"])
            repair_choice_min = float(7.5 * harvester["repair"])
            hp_choice_max = 10 * harvester["hp"]
            attack_choice_max = 10 * harvester["attack"]
            repair_choice_max = 10 * harvester["repair"]
    ...
    for i in range(261, 286): #Mine Layers
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * mine_layer["hp"])
            attack_choice_max = float(1.5 * mine_layer["attack"])
            repair_choice_max = float(1.5 * mine_layer["repair"])
            ...
            hp_choice_min = 2 * mine_layer["hp"]
            attack_choice_min = 2 * mine_layer["attack"]
            repair_choice_min = 2 * mine_layer["repair"]
            ...
            hp_choice_min = 3 * mine_layer["hp"]
            attack_choice_min = 3 * mine_layer["attack"]
            repair_choice_min = 3 * mine_layer["repair"]
            ...
            hp_choice_min = 5 * mine_layer["hp"]
            attack_choice_min = 5 * mine_layer["attack"]
            repair_choice_min = 5 * mine_layer["repair"]
            hp_choice_max = float(7.5 * mine_layer["hp"])
            attack_choice_max = float(7.5 * mine_layer["attack"])
            repair_choice_max = float(7.5 * mine_layer["repair"])
            ...
            hp_choice_min = float(7.5 * mine_layer["hp"])
            attack_choice_min = float(7.5 * mine_layer["attack"])
            repair_choice_min = float(7.5 * mine_layer["repair"])
            hp_choice_max = 10 * mine_layer["hp"]
            attack_choice_max = 10 * mine_layer["attack"]
            repair_choice_max = 10 * mine_layer["repair"]
    ...
    for i in range(286, 311): #Targetting Ships
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * targetting["hp"])
            attack_choice_max = float(1.5 * targetting["attack"])
            repair_choice_max = float(1.5 * targetting["repair"])
            ...
            hp_choice_min = 2 * targetting["hp"]
            attack_choice_min = 2 * targetting["attack"]
            repair_choice_min = 2 * targetting["repair"]
            ...
            hp_choice_min = 3 * targetting["hp"]
            attack_choice_min = 3 * targetting["attack"]
            repair_choice_min = 3 * targetting["repair"]
            ...
            hp_choice_min = 5 * targetting["hp"]
            attack_choice_min = 5 * targetting["attack"]
            repair_choice_min = 5 * targetting["repair"]
            hp_choice_max = float(7.5 * targetting["hp"])
            attack_choice_max = float(7.5 * targetting["attack"])
            repair_choice_max = float(7.5 * targetting["repair"])
            ...
            hp_choice_min = float(7.5 * targetting["hp"])
            attack_choice_min = float(7.5 * targetting["attack"])
            repair_choice_min = float(7.5 * targetting["repair"])
            hp_choice_max = 10 * targetting["hp"]
            attack_choice_max = 10 * targetting["attack"]
            repair_choice_max = 10 * targetting["repair"]
    ...
    for i in range(311, 336): #Mobile Fleet Depot
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * mobile_fleet_depot["hp"])
            attack_choice_max = float(1.5 * mobile_fleet_depot["attack"])
            repair_choice_max = float(1.5 * mobile_fleet_depot["repair"])
            ...
            hp_choice_min = 2 * mobile_fleet_depot["hp"]
            attack_choice_min = 2 * mobile_fleet_depot["attack"]
            repair_choice_min = 2 * mobile_fleet_depot["repair"]
            ...
            hp_choice_min = 3 * mobile_fleet_depot["hp"]
            attack_choice_min = 3 * mobile_fleet_depot["attack"]
            repair_choice_min = 3 * mobile_fleet_depot["repair"]
            ...
            hp_choice_min = 5 * mobile_fleet_depot["hp"]
            attack_choice_min = 5 * mobile_fleet_depot["attack"]
            repair_choice_min = 5 * mobile_fleet_depot["repair"]
            hp_choice_max = float(7.5 * mobile_fleet_depot["hp"])
            attack_choice_max = float(7.5 * mobile_fleet_depot["attack"])
            repair_choice_max = float(7.5 * mobile_fleet_depot["repair"])
            ...
            hp_choice_min = float(7.5 * mobile_fleet_depot["hp"])
            attack_choice_min = float(7.5 * mobile_fleet_depot["attack"])
            repair_choice_min = float(7.5 * mobile_fleet_depot["repair"])
            hp_choice_max = 10 * mobile_fleet_depot["hp"]
            attack_choice_max = 10 * mobile_fleet_depot["attack"]
            repair_choice_max = 10 * mobile_fleet_depot["repair"]
    ...
    for i in range(336, 361): #Destroyers
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * destroyer["hp"])
            attack_choice_max = float(1.5 * destroyer["attack"])
            repair_choice_max = float(1.5 * destroyer["repair"])
            ...
            hp_choice_min = 2 * destroyer["hp"]
            attack_choice_min = 2 * destroyer["attack"]
            repair_choice_min = 2 * destroyer["repair"]
            ...
            hp_choice_min = 3 * destroyer["hp"]
            attack_choice_min = 3 * destroyer["attack"]
            repair_choice_min = 3 * destroyer["repair"]
            ...
            hp_choice_min = 5 * destroyer["hp"]
            attack_choice_min = 5 * destroyer["attack"]
            repair_choice_min = 5 * destroyer["repair"]
            hp_choice_max = float(7.5 * destroyer["hp"])
            attack_choice_max = float(7.5 * destroyer["attack"])
            repair_choice_max = float(7.5 * destroyer["repair"])
            ...
            hp_choice_min = float(7.5 * destroyer["hp"])
            attack_choice_min = float(7.5 * destroyer["attack"])
            repair_choice_min = float(7.5 * destroyer["repair"])
            hp_choice_max = 10 * destroyer["hp"]
            attack_choice_max = 10 * destroyer["attack"]
            repair_choice_max = 10 * destroyer["repair"]
    ...
    for i in range(361, 386): #Battleships
        ...
        if ships_data[str(i)]["rarity"] == 1:
            ...
            hp_choice_max = float(1.5 * battleship["hp"])
            attack_choice_max = float(1.5 * battleship["attack"])
            repair_choice_max = float(1.5 * battleship["repair"])
            ...
            hp_choice_min = 2 * battleship["hp"]
            attack_choice_min = 2 * battleship["attack"]
            repair_choice_min = 2 * battleship["repair"]
            ...
            hp_choice_min = 3 * battleship["hp"]
            attack_choice_min = 3 * battleship["attack"]
            repair_choice_min = 3 * battleship["repair"]
            ...
            hp_choice_min = 5 * battleship["hp"]
            attack_choice_min = 5 * battleship["attack"]
            repair_choice_min = 5 * battleship["repair"]
            hp_choice_max = float(7.5 * battleship["hp"])
            attack_choice_max = float(7.5 * battleship["attack"])
            repair_choice_max = float(7.5 * battleship["repair"])
            ...
            hp_choice_min = float(7.5 * battleship["hp"])
            attack_choice_min = float(7.5 * battleship["attack"])
            repair_choice_min = float(7.5 * battleship["repair"])
            hp_choice_max = 10 * battleship["hp"]
            attack_choice_max = 10 * battleship["attack"]
            repair_choice_max = 10 * battleship["repair"]
